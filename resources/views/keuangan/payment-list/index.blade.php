...
<nav aria-label="breadcrumb mb-0">
    <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item">
        <a href="{{route('payment-list.index')}}">@yield('title')</a>
      </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- AKHIR TOMBOL -->
                            <table class="table table-hover table-responsive" id="table_payment_list">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Payment Name</th>
...
@section('script')
  ...
  <script>
    ...
    // DATATABLE
    $(document).ready(function () {
        var table = $('#table_payment_list').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('payment-list.index') }}",
            columns: [
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var oTable = $('#table_payment_list').dataTable();
                        oTable.fnDraw(false);
                        Swal.fire({
                            title: 'Good job!',
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('payment-list/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Edit data");
            $('#tombol-simpan').val("edit-post");
            $('#tambah-edit-modal').modal('show');
              
            $('#id').val(data.id);
            $('#nama_pembayaran').val(data.nama_pembayaran);
        })
    });
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        ...
                        $('#table_payment_list').DataTable().ajax.reload(null, true);
                    }).fail(function() {
                        Swal.fire({
                            title: 'Oops!',
