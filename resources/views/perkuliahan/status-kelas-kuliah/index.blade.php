...
@section('title','Status Kelas Kuliah')
...
<nav aria-label="breadcrumb mb-0">
    <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item">
        <a href="{{route('status-kelas-kuliah.index')}}">@yield('title')</a>
      </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- AKHIR TOMBOL -->
                            <table class="table table-hover table-responsive" id="table_status_kelas_kuliah">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Name</th>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_status" name="nama_status" value="" placeholder="eg: Convert" />
...
<script>
    ...
    // DATATABLE
    $(document).ready(function () {
        var table = $('#table_status_kelas_kuliah').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('status-kelas-kuliah.index') }}",
            columns: [
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('status-kelas-kuliah.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        ...
                        $('#table_status_kelas_kuliah').DataTable().ajax.reload(null, true);
                        Swal.fire({
                            title: 'Good job!',
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('status-kelas-kuliah/' + data_id + '/edit', function (data) {
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        url: "status-kelas-kuliah/" + dataId,
                        type: 'DELETE',
                        data: {id:dataId},
                        dataType: 'json'
