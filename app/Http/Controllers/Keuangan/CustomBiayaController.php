        ...
        if($request->ajax()){
            return datatables()->of($dataCustomBiaya)
                ->addColumn('action', function($data){
                    ...
                    return '<a href="'.Route('potongan-biaya',['id' => $data->id]).'" name="potongan" class="dropdown-shortcuts-add text-body potongan" data-id="'.$data->id.'" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Set Disc."><span class="badge bg-label-primary me-1"><i class="bx bx-sm bx-plus-circle bx-tada"></i> Atur Potongan</span></a>';
                })
